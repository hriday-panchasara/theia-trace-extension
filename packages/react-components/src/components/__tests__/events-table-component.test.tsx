...
describe('Table output component tests', () => {
    ...
    test('Renders AG-Grid table with provided props & state', async () => {
        const tableOutputComponentProps: AbstractOutputProps = {
            ...
            markerSetId: '0',
            range: new TimeRange(BigInt(0), BigInt(10)),
            nbEvents: 20,
            viewRange: new TimeRange(BigInt(0), BigInt(10)),
            selectionRange: undefined,
            onOutputRemove: () => 0,
            unitController: new TimeGraphUnitController(BigInt(10), { start: BigInt(0), end: BigInt(10)}),
            widthWPBugWorkaround: 1500,
